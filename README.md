...
- main.go:796: // @todo(nick-ng): move this to its own loop
...
- utils/poe-ninja.go:233: @todo(nick-ng): the poe.ninja endpoint this calls doesn't return stack size anymore. That is in a different endpoint. you have to update this before you can use it again
