...
- main.go:383: @todo(nick-ng): move some functions to separate files
- main.go:638: @todo(nick-ng): move these to a method so we can process all commands (multi-line or otherwise) in a single loop?
