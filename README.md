...
- main.go:331: @todo(nick-ng): move some functions to separate files
- main.go:586: @todo(nick-ng): move these to a method so we can process all commands (multi-line or otherwise) in a single loop?
- main.go:712: // @todo(nick-ng): move this to its own loop
